...
| **Day-02: Application**            | Demonstrates a practical application of servlets by creating a simple in-memory CRUD system for managing customers. It introduces the concept of a controller servlet, uses the concept of POJO (Plain Old Java Object) | `CustomerServlet.java`, `Customer.java`                                                                                                |
